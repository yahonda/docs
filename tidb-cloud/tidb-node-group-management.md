...
3.  **「TiDB ノード グループ」**リストから TiDB ノード グループを選択し、 **「接続タイプ」**リストから**Connection Type**を選択します。
...
6.  **[パブリック エンドポイント]**セクションで**Public Endpoint**をクリックし、 **[IP アクセス リスト]**セクションで**[IP アドレスの追加]**をクリックします。
...
3.  **TiDB ノード グループ**リストから TiDB ノード グループを選択し、**Private Endpoint**リストから**Connection Type**を選択します。
