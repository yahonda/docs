...
-   メンテナンスウィンドウを無効にすることはできますか？
    ...
    いいえ。メンテナンス期間はデフォルトで有効になっており、無効にすることはできません。メンテナンス期間の開始時刻を変更したり、期限までメンテナンス タスクを再スケジュールしたりできます。詳細については、[メンテナンスウィンドウのビューと設定](#view-and-configure-maintenance-windows)を参照してください。
