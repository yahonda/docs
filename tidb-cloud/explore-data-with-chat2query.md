...
-   AIを無効にするには、 [TiDB Cloudコンソール](https://tidbcloud.com/)の左下隅にある<MDSvgIcon name="icon-top-account-settings" />をクリックします。**Account Settings**をクリックし、 **AIとプライバシーの**タブをクリックして、 **AIによるデータ探索**オプションを無効にします。
