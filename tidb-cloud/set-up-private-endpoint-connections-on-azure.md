...
3.  **Connection Type**ドロップダウンリストで**Private Endpoint**を選択し、 **「プライベートエンドポイント接続の作成」**をクリックして、 **「Azureプライベートエンドポイント接続の作成」**ダイアログを開きます。
...
5.  **「リソース」**タブで、**connection method**として**「リソース ID またはエイリアスを使用して Azure リソースに接続する」**を選択し、コピーしたTiDB Cloudリソース ID を**「リソース ID またはエイリアス」**フィールドに貼り付けます。
