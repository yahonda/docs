...
3.  **Connection Type**ドロップダウンリストで**Private Endpoint**を選択し、 **「プライベートエンドポイント接続の作成」を**クリックします。
...
2.  **VPC network**&gt;**プライベート サービス接続**&gt;**Connected endpoints**に移動し、 **Connect endpoint**をクリックします。
