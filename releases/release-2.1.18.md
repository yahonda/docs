...
-   SQLオプティマイザー
    ...
    -   `AntiSemiJoin` の結合条件で渡される誤った式を修正 [＃12800](https://github.com/pingcap/tidb/pull/12800)
-   SQLエンジン
    ...
    -   監視レコードに、ステートメント`PREPARE`の`sql_type`による期間が表示されない問題を修正しました。 [＃12329](https://github.com/pingcap/tidb/pull/12329)
    -   `from_unixtime`関数が null を処理するときに発生panic問題を修正 [＃12572](https://github.com/pingcap/tidb/pull/12572)
    -   `YEAR`型として無効な値が挿入されると、結果が`0000` ではなく`NULL`なるという互換性の問題を修正しました。 [＃12744](https://github.com/pingcap/tidb/pull/12744)
...
-   サーバ
    ...
    -   スロークエリログの`COM_STMT_FETCH`回限りのレコードがMySQL ものと矛盾する問題を修正しました。 [＃12953](https://github.com/pingcap/tidb/pull/12953)
...
-   pd-ctl の`--help`コマンド出力を改善する [＃1772](https://github.com/pingcap/pd/pull/1772)
...
-   TiDB Binlog に「キューサイズ」と「クエリヒストグラム」の 2 つの監視項目を追加します。 [＃952](https://github.com/pingcap/tidb-ansible/pull/952)
