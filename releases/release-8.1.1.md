...
-   ツール
    ...
    -   TiCDC
        ...
        -   シンプルプロトコルを使用したチェンジフィードがで開始されたときに、すべてのテーブルの BOOTSTRAP メッセージをダウンストリームに一度に送信することをサポートします。 [＃11315](https://github.com/pingcap/tiflow/issues/11315) @ [asddongmen](https://github.com/asddongmen)
...
-   TiDB
    ...
    -   `_tidb_rowid`の`PointGet`実行プランがで生成できる問題を修正 [＃54583](https://github.com/pingcap/tidb/issues/54583) @ [Defined2014](https://github.com/Defined2014)
    ...
    -   DDL ステートメントが etcd を誤って使用し、タスクがでキューに入れられる問題を修正しました。 [＃52335](https://github.com/pingcap/tidb/issues/52335) @ [wjhuang2016](https://github.com/wjhuang2016)
...
-   PD
    ...
    -   `scheduling`マイクロサービスがで有効化された後にスケーリングの進行状況が正しく表示されない問題を修正しました [＃8331](https://github.com/tikv/pd/issues/8331) @ [rleungx](https://github.com/rleungx)
