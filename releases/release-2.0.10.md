...
-   終了信号受信してもTiDBが終了できない可能性がある問題を修正しました [＃8501](https://github.com/pingcap/tidb/pull/8501)
-   `IndexLookUpJoin`場合によっては間違った結果が返される問題を修正[＃8508](https://github.com/pingcap/tidb/pull/8508)
-   `GetVar`または`SetVar` を含むフィルターをプッシュダウンないでください [＃8454](https://github.com/pingcap/tidb/pull/8454)
...
-   `VALUES`関数の引数が列目ではない場合に発生するpanic問題を修正しました [＃8404](https://github.com/pingcap/tidb/pull/8404)
