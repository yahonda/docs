...
-   TiDB
    ...
    -   `max_prepared_stmt_count`の設定がで@[xuyifangreeneyes](https://github.com/xuyifangreeneyes)に反映されない問題を修正 [＃39735](https://github.com/pingcap/tidb/issues/39735)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   TiCDCがオブジェクトストレージ @ [Rustin170506](https://github.com/Rustin170506)にデータを複製するときにパーティションセパレーターが機能しない問題を修正しました [＃8581](https://github.com/pingcap/tiflow/issues/8581) @ [CharlesCheung96](https://github.com/CharlesCheung96)
