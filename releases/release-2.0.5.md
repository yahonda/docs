...
-   改善点
    ...
    -   `Load Data`文で`\N` NULL として処理する [＃6962](https://github.com/pingcap/tidb/pull/6962)
...
-   バグ修正
    ...
    -   `CREATE TABLE IF NOT EXISTS LIKE`行動修正する [＃6928](https://github.com/pingcap/tidb/pull/6928)
