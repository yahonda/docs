...
-   TiKV
    ...
    -   ピアメッセージチャネルのメモリ使用量を[コナー1996](https://github.com/Connor1996)に減らす [＃16229](https://github.com/tikv/tikv/issues/16229)
...
-   TiFlash
    ...
    -   `LENGTH()`と`ASCII()`関数の実行効率を@[xzhangxian1008](https://github.com/xzhangxian1008)で最適化 [＃9344](https://github.com/pingcap/tiflash/issues/9344)
...
-   TiDB
    ...
    -   `mysql.stats_histograms`表の`tot_col_size`列目が負の数になる可能性がある問題を修正しました [＃55126](https://github.com/pingcap/tidb/issues/55126) @ [qw4990](https://github.com/qw4990)
...
-   PD
    ...
    -   `replication.strictly-match-label`を`true`に設定するとTiFlashがで起動しなくなる問題を修正 [＃8480](https://github.com/tikv/pd/issues/8480) @ [rleungx](https://github.com/rleungx)
