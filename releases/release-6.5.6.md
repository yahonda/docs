...
-   TiCDC Changefeed、次の新しい構成項目が導入されています。
    -   [`sql-mode`](/ticdc/ticdc-changefeed-config.md) : TiCDC がデータを複製するときに DDL ステートメントを解析するために使用する[SQLモード](https://docs.pingcap.com/tidb/v6.5/ticdc-ddl#sql-mode)設定できます[＃9876](https://github.com/pingcap/tiflow/issues/9876) @ [asddongmen](https://github.com/asddongmen)
...
-   ツール
    ...
    -   Backup & Restore (BR)
        ...
        -   BRは、 `merge-schedule-limit`構成を`0` に設定することで、リージョンのマージを一時停止できます。 [＃7148](https://github.com/tikv/pd/issues/7148) @ [3pointer](https://github.com/3pointer)
...
-   TiDB
    ...
    -   `AUTO_ID_CACHE=1` 使用時の Goroutine リークの問題を修正 [＃46324](https://github.com/pingcap/tidb/issues/46324) @ [tiancaiamao](https://github.com/tiancaiamao)
...
-   TiKV
    ...
    -   リージョンと@[cfzjywxk](https://github.com/cfzjywxk)間でメタデータが一致しないためにTiKVがパニックを起こす問題を修正しました [＃13311](https://github.com/tikv/tikv/issues/13311)
...
-   PD
    ...
    -   `evict-leader-scheduler` @[HuSharp](https://github.com/HuSharp)で構成失う可能性がある問題を修正 [＃6897](https://github.com/tikv/pd/issues/6897)
...
-   ツール
    ...
    -   Backup & Restore (BR)
        ...
        -   PD所有者がから[ユジュンセン](https://github.com/YuJuncen)転送されたときにログバックアップがpanic可能性がある問題を修正しました [＃47533](https://github.com/pingcap/tidb/issues/47533)
    ...
    -   TiDB Lightning
        ...
        -   `write to tikv with no leader returned`エラーが発生したときにデータのインポートが失敗する問題を修正しました [＃45673](https://github.com/pingcap/tidb/issues/45673) @ [lance6716](https://github.com/lance6716)
        ...
        -   TiDB Lightningが`writeToTiKV` で停止する問題を修正 [＃46321](https://github.com/pingcap/tidb/issues/46321) @ [lance6716](https://github.com/lance6716)
