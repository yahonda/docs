...
-   SQLオプティマイザー
    ...
    -   `Not`演算子プッシュダウンるときに元の式を変更しないでください [＃10363](https://github.com/pingcap/tidb/pull/10363/files)
    -   ヒストグラムの`dump`相関`load`サポート [＃10573](https://github.com/pingcap/tidb/pull/10573)

-   実行エンジン
    -   `batchChecker` で重複行をフェッチするときに、一意インデックスを持つ仮想列を適切に処理します。 [＃10370](https://github.com/pingcap/tidb/pull/10370)
    -   `CHAR`列スキャン範囲計算の問題を修正 [＃10124](https://github.com/pingcap/tidb/pull/10124)
...
-   サーバ
    ...
    -   `RBAC` 分の`role`のデータベース権限判定を修正 [＃10261](https://github.com/pingcap/tidb/pull/10261)
...
-   DDL
    ...
    -   テーブル作成時にテーブルリージョンを事前割り当てして、 作成後の書き込みホットスポットを回避するテーブルパーティションのサポート`preSplit` [＃10221](https://github.com/pingcap/tidb/pull/10221)
...
-   `ScanRegions` の gRPC インターフェースを追加する [＃1535](https://github.com/pingcap/pd/pull/1535)
...
-   不一致の`Config`ステータスの問題を修正 [＃1476](https://github.com/pingcap/pd/pull/1476)
...
-   コプロセッサー
    -   RPN関数を追加する
        ...
        -   `Int` の比較演算をサポート [＃4625](https://github.com/tikv/tikv/pull/4625)
        -   `Decimal` の比較演算をサポート [＃4625](https://github.com/tikv/tikv/pull/4625)
        -   `String` の比較演算をサポート [＃4625](https://github.com/tikv/tikv/pull/4625)
        ...
        -   `Int` のサポートプラス算術 [＃4733](https://github.com/tikv/tikv/pull/4733)
        -   `Real` のサポートプラス算術 [＃4733](https://github.com/tikv/tikv/pull/4733)
        -   `Decimal` のサポートプラス算術 [＃4733](https://github.com/tikv/tikv/pull/4733)
        ...
        -   `Int` のマイナス演算をサポート [＃4746](https://github.com/tikv/tikv/pull/4746)
        -   `Real` のマイナス演算をサポート [＃4746](https://github.com/tikv/tikv/pull/4746)
        -   `Decimal` のマイナス演算をサポート [＃4746](https://github.com/tikv/tikv/pull/4746)
