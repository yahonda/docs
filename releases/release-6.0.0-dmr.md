...
-   ツール
    ...
    -   TiCDC
        ...
        -   `Canal-JSON` nil をサポートしていないために発生する可能性がある TiCDCpanic問題を修正しました [＃4736](https://github.com/pingcap/tiflow/issues/4736)
        ...
        -   Avroが`NOT NULL`列目をNULL許容フィールドに変換するバグを修正 [＃4818](https://github.com/pingcap/tiflow/issues/4818)
