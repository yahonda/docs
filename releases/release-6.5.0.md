...
-   `INSERT` `UPDATE`含む非トランザクションDMLステートメント`DELETE` にサポートし[エキシウム](https://github.com/ekexium) `REPLACE` [＃33485](https://github.com/pingcap/tidb/issues/33485)
...
-   TiKV- BR GA: RawKV @ [haojinming](https://github.com/haojinming)のバックアップと復元をサポート [＃67](https://github.com/tikv/migration/issues/67) @ [pingyu](https://github.com/pingyu)
...
-   TiDB
    ...
    -   `BIT`と`CHAR`列目については、 `INFORMATION_SCHEMA.COLUMNS`の結果をMySQL と一致させる [＃25472](https://github.com/pingcap/tidb/issues/25472) @ [hawkingrei](https://github.com/hawkingrei)
...
-   PD
    ...
    -   墓石ストアの自動ガベージコレクション機能を追加 [＃5348](https://github.com/tikv/pd/issues/5348) @ [nolouch](https://github.com/nolouch)
...
-   TiDB
    ...
    -   パーティションテーブルのパーティション列を変更すると、DDLがでハングする問題を修正しました。 [＃38530](https://github.com/pingcap/tidb/issues/38530) @ [mjonss](https://github.com/mjonss)
    ...
    -   誤って`StreamAgg` TiFlashにプッシュダウンると、間違った結果が発生する問題を修正しました。 [＃39266](https://github.com/pingcap/tidb/issues/39266) @ [fixdb](https://github.com/fixdb)
...
-   TiFlash
    ...
    -   TiFlashファイルオープンOPSがで高すぎる問題を修正 [＃6345](https://github.com/pingcap/tiflash/issues/6345) @ [JaySon-Huang](https://github.com/JaySon-Huang)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   PDリーダーがでクラッシュするとTiCDCが停止する問題を修正 [＃7470](https://github.com/pingcap/tiflow/issues/7470) @ [zeminzhou](https://github.com/zeminzhou)
