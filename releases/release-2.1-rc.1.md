...
-   SQLオプティマイザー
    ...
    -   場合によっては一意インデックスを使用して`NULL`値が見つからない問題を修正 [＃7163](https://github.com/pingcap/tidb/pull/7163)
    ...
    -   主キーが整数場合に`USE INDEX(PRIMARY)`使用できない問題を修正 [＃7316](https://github.com/pingcap/tidb/pull/7316)
...
-   SQL実行エンジン
    ...
    -   `MergeJoin` `IndexJoin` `NULL`値処理するときの誤った結果を修正 [＃7255](https://github.com/pingcap/tidb/pull/7255)
...
-   統計
    ...
    -   `AccessPath`コスト見積戦略最適化する [＃7233](https://github.com/pingcap/tidb/pull/7233)
-   サーバ
    ...
    -   `mismatchClusterID`問題処理する [＃7053](https://github.com/pingcap/tidb/pull/7053)
    -   `advertise-address`構成項目追加する [＃7078](https://github.com/pingcap/tidb/pull/7078)
    -   `GrpcKeepAlive`オプション追加 [＃7100](https://github.com/pingcap/tidb/pull/7100)
...
-   互換性
    ...
    -   `flush status`構文サポートする [＃7369](https://github.com/pingcap/tidb/pull/7369)
...
-   DDL
    ...
    -   `information_schema.tables` 分の`AUTO-INCREMENT`の表示問題を修正 [＃7037](https://github.com/pingcap/tidb/pull/7037)
