...
-   JSON内の`&`など文字が誤ってエスケープされる問題`<`修正しました`>` [＃14637](https://github.com/pingcap/tidb/pull/14637)
...
-   Raftstore
    -   リージョンマージの失敗によって発生するシステムpanicの問題 #6460 またはデータ損失の問題 #598 を修正しました [＃6481](https://github.com/tikv/tikv/pull/6481)
