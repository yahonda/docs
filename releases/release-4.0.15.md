...
-   PD
    ...
    -   PD間のリージョン情報の同期パフォーマンスを向上[＃3932](https://github.com/tikv/pd/pull/3932)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   `file sorter` を削除 [＃2325](https://github.com/pingcap/tiflow/pull/2325)
...
-   TiDB
    ...
    -   文書化されていない`/debug/sub-optimal-plan` HTTP API を削除する [＃27264](https://github.com/pingcap/tidb/pull/27264)

    -   `case when`式の文字セットと照合順序が間違っている問題を修正しました [＃26662](https://github.com/pingcap/tidb/issues/26662)
...
-   TiKV
    ...
    -   暗号化ファイル辞書から古いファイル情報をチェックする [＃9115](https://github.com/tikv/tikv/issues/9115)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   新しい変更フィードを作成するときに発生する可能性のあるメモリリークの問題を修正しました [＃2389](https://github.com/pingcap/tiflow/issues/2389)
        ...
        -   `SinkManager` のマップへの安全でない同時アクセスの問題を修正 [＃2298](https://github.com/pingcap/tiflow/pull/2298)
