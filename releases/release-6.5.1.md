...
-   TiDB
    ...
    -   [`pessimistic-auto-commit`](/tidb-configuration-file.md#pessimistic-auto-commit-new-in-v600)構成項目がポイント取得クエリで有効にならない問題を修正しました [＃39928](https://github.com/pingcap/tidb/issues/39928) @ [zyguan](https://github.com/zyguan)
    ...
    -   `globalMemoryControl`クエリを強制終了しているときに、 `KILL`操作がで終了しない可能性がある問題を修正しました [＃41057](https://github.com/pingcap/tidb/issues/41057) @ [wshwsh12](https://github.com/wshwsh12)
    ...
    -   自動分析により TiDB がで終了できなくなる問題を修正しました [＃40038](https://github.com/pingcap/tidb/issues/40038) @ [xuyifangreeneyes](https://github.com/xuyifangreeneyes)
    ...
    -   パーティションテーブルにグローバルバインディングを作成すると、TiDB がで起動に失敗する可能性がある問題を修正しました。 [＃40368](https://github.com/pingcap/tidb/issues/40368) @ [Yisaer](https://github.com/Yisaer)
...
-   ツール
    ...
    -   Backup & Restore (BR)
        ...
        -   PITRエラーがで上書きされる問題を修正 [＃40576](https://github.com/pingcap/tidb/issues/40576) @ [Leavrth](https://github.com/Leavrth)
    ...
    -   TiCDC
        ...
        -   TiCDCが大きなトランザクションを[ハイラスティン](https://github.com/Rustin170506)に分割せずにデータを複製するとコンテキスト期限が超過するバグを修正 [＃7982](https://github.com/pingcap/tiflow/issues/7982)
