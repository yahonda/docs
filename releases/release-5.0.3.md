...
-   TiDB
    ...
    -   内蔵機能`replace()` TiFlash に押し下げる機能をサポート [＃25565](https://github.com/pingcap/tidb/pull/25565)
    ...
    -   内蔵機能`str_to_date` TiFlash に押し下げる機能をサポート [＃25148](https://github.com/pingcap/tidb/pull/25148)
