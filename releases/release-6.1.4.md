...
-   TiDB
    ...
    -   一部のパターンの`IN`と`NOT IN`サブクエリが`Can't find column`エラー @ [lance6716](https://github.com/lance6716)を報告する問題を修正しました [＃37032](https://github.com/pingcap/tidb/issues/37032) @ [AilinKid](https://github.com/AilinKid)
...
-   ツール
    ...
    -   TiCDC
        ...
        -   `changefeed query`結果のうち`sasl-password`がでマスクされない問題を修正しました [＃7182](https://github.com/pingcap/tiflow/issues/7182) @ [dveeden](https://github.com/dveeden)
    ...
    -   TiDB Data Migration (DM)
        ...
        -   テーブルに`update-old-value-expr`または`update-new-value-expr`のいずれか一方のみが設定されている場合に、フィルタルールが有効にならないか、DM がでパニックになるバグを修正しました。 [＃7774](https://github.com/pingcap/tiflow/issues/7774) @ [lance6716](https://github.com/lance6716)
