...
-   TiDB
    ...
    -   インデックス プランが順序に保たれている場合に、インデックス マージによって部分的な制限が誤って押し下げられる問題を修正しました。 [＃52947](https://github.com/pingcap/tidb/issues/52947) @ [AilinKid](https://github.com/AilinKid)
    ...
    -   `LIMIT` `OR`型`Index Merge` に押し下げられない可能性がある問題を修正しました [＃48588](https://github.com/pingcap/tidb/issues/48588) @ [AilinKid](https://github.com/AilinKid)
