...
-   TiDB
    ...
    -   `GROUP_CONCAT`関数の`ORDER BY`節をサポートする [＃16988](https://github.com/pingcap/tidb/pull/16988)
...
-   TiDB
    ...
    -   時間が高価なしきい値超えたときに`MAX_EXEC_TIME`ヒントが有効にならない問題を修正 [＃17534](https://github.com/pingcap/tidb/pull/17534)
