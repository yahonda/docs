...
-   統計ヒストグラム空であることによる問題を修正 [＃7927](https://github.com/pingcap/tidb/pull/7927)
...
-   `USING`節で`utf8mb4`文字セットの指定をサポート [＃8048](https://github.com/pingcap/tidb/pull/8048)
...
-   `admin show next_row_id`ステートメントサポートする [＃8274](https://github.com/pingcap/tidb/pull/8274)
...
-   `tidb_max_chunk_size`グローバル変数に変更する [＃8333](https://github.com/pingcap/tidb/pull/8333)
...
-   `max-tasks-xxx`構成を放棄し、 `max-tasks-per-worker-xxx` を追加する [＃3093](https://github.com/tikv/tikv/pull/3093)
