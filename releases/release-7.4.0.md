...
-   TiCDCはPulsar @ [asddongmen](https://github.com/asddongmen)へのデータ複製をサポート [＃9413](https://github.com/pingcap/tiflow/issues/9413) @ [yumchina](https://github.com/yumchina)
...
-   TiKV
    ...
    -   RocksDB の`background_compaction` [栄光](https://github.com/glorv)で動的に調整するサポート [＃15424](https://github.com/tikv/tikv/issues/15424)
...
-   TiKV
    ...
    -   リージョンのメタデータが正しくないことによって引き起こされるTiKVpanic問題を修正しました [＃13311](https://github.com/tikv/tikv/issues/13311) @ [zyguan](https://github.com/zyguan)
