...
-   SQLオプティマイザー
    ...
    -   `SHOW`文でサブクエリをサポート（ `SHOW COLUMNS FROM tbl WHERE FIELDS IN (SELECT 'a')` など） [＃11459](https://github.com/pingcap/tidb/pull/11459)
...
-   SQL実行エンジン
    ...
    -   `EXPLAIN` の結果に`CARTESIAN` Joinを加える [＃11429](https://github.com/pingcap/tidb/pull/11429)
    ...
    -   `DATE_ADD`関数の区間分数の符号を誤って処理することによって発生する誤った結果を修正しました。 [＃11615](https://github.com/pingcap/tidb/pull/11615)
...
-   サーバ
    ...
    -   リージョン関連のリクエストがHTTP API でパーティションテーブル関連のリージョンを返さない問題を修正 [＃11466](https://github.com/pingcap/tidb/pull/11466)
    -   ユーザーが手動で悲観的ロックを検証するときに、遅い操作によって発生するロック タイムアウトの可能性を減らすには、次の変更を行います。 [＃11521](https://github.com/pingcap/tidb/pull/11521)
...
-   ストレージエンジンサイズ監視精度を向上 [＃5200](https://github.com/tikv/tikv/pull/5200)
-   tikv-ctl のリージョンサイズの精度を向上 [＃5195](https://github.com/tikv/tikv/pull/5195)
-   悲観的ロックのデッドロック検出器のパフォーマンスを向上させる[＃5192](https://github.com/tikv/tikv/pull/5192)
-   TitanストレージエンジンのGCのパフォーマンスを向上 [＃5197](https://github.com/tikv/tikv/pull/5197)
...
-   pd-ctl で削除トゥームストーン操作が実行できないバグを修正しました [＃1651](https://github.com/pingcap/pd/pull/1651)
...
-   TiKVダッシュボードのアロケータ統計監視項目を更新します。 [＃857](https://github.com/pingcap/tidb-ansible/pull/857)
-   Node Exporterの警告式の単位エラーを修正しました [＃860](https://github.com/pingcap/tidb-ansible/pull/860)
-   TiSpark jarパッケージをv2.1.2にアップグレードする[＃862](https://github.com/pingcap/tidb-ansible/pull/862)
-   Ansible タスク機能の説明を更新 [＃867](https://github.com/pingcap/tidb-ansible/pull/867)
-   TiDB Dashboardのローカルリーダーリクエスト監視項目の表現を更新します。 [＃874](https://github.com/pingcap/tidb-ansible/pull/874)
-   概要ダッシュボードの TiKV メモリ監視項目の表現を更新し、監視が誤って表示される問題を修正しました。 [＃879](https://github.com/pingcap/tidb-ansible/pull/879)
-   Kafka モードでBinlogサポートを削除する [＃878](https://github.com/pingcap/tidb-ansible/pull/878)
-   `rolling_update.yml`操作を実行するときにPDがLeaderの転送に失敗する問題を修正しました [＃887](https://github.com/pingcap/tidb-ansible/pull/887)
